import { _ as __extends$1, a as __spreadArray, b as __awaiter, c as __generator, g as getUA, d as isMobileCordova, e as isReactNative, f as isElectron, h as isIE, j as isUWP, k as isBrowserExtension, l as getModularInstance, L as LogLevel, m as Logger, C as Component, n as firebase$1 } from '../common/index.esm-5f8ccdf1.js';
 ...
 */ function N(t) {
    ...
    if (S.logLevel <= LogLevel.DEBUG) {
        var r = e.map(x);
        S.debug.apply(S, __spreadArray([ "Firestore (8.4.0): " + t ], r));
    }
}
...
function A(t) {
    ...
    if (S.logLevel <= LogLevel.ERROR) {
        var r = e.map(x);
        S.error.apply(S, __spreadArray([ "Firestore (8.4.0): " + t ], r));
    }
}
...
function k(t) {
    ...
    if (S.logLevel <= LogLevel.WARN) {
        var r = e.map(x);
        S.warn.apply(S, __spreadArray([ "Firestore (8.4.0): " + t ], r));
    }
}
...
// Visible for testing
var dr = __spreadArray(__spreadArray([], __spreadArray(__spreadArray([], __spreadArray(__spreadArray([], __spreadArray(__spreadArray([], [ Zn.store, tr.store, er.store, ir.store, sr.store, Jn.store, ar.store, ur.store ]), [ hr.store ])), [ or.store ])), [ cr.store ])), [ fr.store, lr.store ]), pr = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", yr = /** @class */ function() {
    function t() {
 ...
 */ var li = /** @class */ function() {
    ...
    return t.prototype.calculateTargetCount = function(t, e) {
        ...
        return this.calculateTargetCount(t, this.params.percentileToCollect).next((function(e) {
            ...
            return a = Date.now(), D() <= LogLevel.DEBUG && N("LruGarbageCollector", "LRU Garbage Collection\n\tCounted targets in " + (o - f) + "ms\n\tDetermined least recently used " + r + " in " + (s - o) + "ms\n\tRemoved " + i + " targets in " + (u - s) + "ms\n\tRemoved " + t + " documents in " + (a - u) + "ms\nTotal Duration: " + (a - f) + "ms"), 
            mr.resolve({
                didRun: !0,
 ...
 */
    ...
    /** Returns all local documents matching the specified query. */ t.prototype.getDocumentsMatchingQuery = function(t, e, n, r) {
        ...
        // collection, rather than to perform individual lookups.
            ...
            var s = i.Cn(e, o);
            return (zt(e) || Wt(e)) && i.Nn(e.limitType, s, r, n) ? i.Dn(t, e) : (D() <= LogLevel.DEBUG && N("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), ne(e)), 
    ...
    t.prototype.Nn = function(t, e, n, r) {
        ...
        return D() <= LogLevel.DEBUG && N("QueryEngine", "Using full collection scan to execute query:", ne(e)), 
 ...
 */
            ...
            t.stat === Stat.PROXY ? N("Connection", "Detected buffering proxy") : t.stat === Stat.NOPROXY && N("Connection", "Detected no buffering proxy");
        })), setTimeout((function() {
 ...
 */ function Hu(t, e) {
    ...
    if (t = getModularInstance(t), Pu("collection", "path", e), t instanceof Gu) return qu(n = Q.fromString.apply(Q, __spreadArray([ e ], r))), 
    ...
    return qu(n = Q.fromString.apply(Q, __spreadArray([ t.path ], r)).child(Q.fromString(e))), new Wu(t.firestore, 
    /* converter= */ null, n);
}
 ...
 */ function Yu(t, e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = P.u()), Pu("doc", "path", e), t instanceof Gu) return Vu(n = Q.fromString.apply(Q, __spreadArray([ e ], r))), 
    new Qu(t, 
    /* converter= */ null, new st(n));
    if (!(t instanceof Qu || t instanceof Wu)) throw new T(E.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    return Vu(n = t._path.child(Q.fromString.apply(Q, __spreadArray([ e ], r)))), new Qu(t.firestore, t instanceof Wu ? t._converter : null, new st(n));
}
 ...
 * Firestore database.
 */ function Xu(t, e) {
    return t = getModularInstance(t), e = getModularInstance(e), (t instanceof Qu || t instanceof Wu) && (e instanceof Qu || e instanceof Wu) && t.firestore === e.firestore && t.path === e.path && t._converter === e._converter
    /**
...
function $u(t, e) {
    return t = getModularInstance(t), e = getModularInstance(e), t instanceof zu && e instanceof zu && t.firestore === e.firestore && te(t._query, e._query) && t._converter === e._converter
    /**
 * @license
 * Copyright 2020 Google LLC
 *
...
var sc = /** @class */ function(t) {
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = getModularInstance(e)) || e instanceof ua ? Da(this._dataReader, "WriteBatch.update", s._key, e, n, r) : Sa(this._dataReader, "WriteBatch.update", s._key, e), 
 ...
 */ function hc(t, e, n) {
    ...
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = getModularInstance(e)) || e instanceof ua ? Da(s, "updateDoc", t._key, e, n, r) : Sa(s, "updateDoc", t._key, e)).toMutation(t._key, Ee.exists(!0)) ]);
}
 ...
 */ var pc = /** @class */ function(t) {
    ...
    return t.prototype.get = function(t) {
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = getModularInstance(e)) || e instanceof ua ? Da(this._dataReader, "Transaction.update", s._key, e, n, r) : Sa(this._dataReader, "Transaction.update", s._key, e), 
...
var Sc = /** @class */ function() {
    ...
    return t.nu = function(e, n, r) {
        ...
        return (t = getModularInstance(t)) instanceof Qu && Xu(this._delegate, t);
    }, t.prototype.set = function(t, e) {
